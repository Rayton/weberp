...
if (isset($_POST['submit'])) {
	...
	*/
	...
	if ($InputError !=1){
		...
		echo $_SESSION['CountryOfOperation']. ' equal to ' .$_POST['X_CountryOfOperation'];
		if ($_SESSION['CountryOfOperation'] != $_POST['X_CountryOfOperation'] ) {
			$sql1 = "UPDATE config SET confvalue = '". $_POST['X_CountryOfOperation'] ."' WHERE confname = 'CountryOfOperation'";

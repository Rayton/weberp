...
*/
	...
	foreach ($_SESSION['Items'.$identifier]->LineItems as $OrderLine) {
		...
		echo '<td class="number">' . locale_number_format($SubTotal,$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>';
		...
		echo '<td class="number">' . locale_number_format($TaxLineTotal ,$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>';
		echo '<td class="number">' . locale_number_format($SubTotal + $TaxLineTotal ,$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>';
	...
	echo '<tr class="EvenTableRows">
			...
			<td class="number">' .locale_number_format(($_SESSION['Items'.$identifier]->total),$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>
			<td class="number">' .locale_number_format($TaxTotal,$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>
			<td class="number">' .locale_number_format(($_SESSION['Items'.$identifier]->total+$TaxTotal),$_SESSION['Items'.$identifier]->DefaultCurrency) . '</td>
		</tr>
		</table>';
	...
	echo '<tr><td>' . _('Amount Paid') . ':</td><td><input type="text" class="number" name="AmountPaid" maxlength="12" size="12" value="' .locale_number_format(round($_POST['AmountPaid'],2),$_SESSION['Items'.$identifier]->DefaultCurrency) . '" /></td></tr>';
